<template>
    <div class="container_warp">
      ...
      <div class="sidebar">
        <div class="btn-group">
          <div class="btn" title="平台" @mousedown="startDrag('platform',$event)">
            <i class="iconfont icon-circle"></i>
          </div>
          <div class="btn" title="系统" @mousedown="startDrag('system',$event)">
            <i class="iconfont icon-circle"></i>
          </div>

          <div class="btn" title="外部接口" @mousedown="startDrag('interfaceOut',$event)">
            <i class="iconfont icon-circle"></i>
          </div>

          <div class="btn" title="内部接口" @mousedown="startDrag('interfaceIn',$event)">
            <i class="iconfont icon-circle"></i>
          </div>
